...
** How to mount a network drive using CIFS (SMB) protocol?
#+BEGIN_SRC sh
  mkdir /mnt/NAS/disk_1;
...
#+BEGIN_SRC text
//192.168.1.235/Disk_1 /mnt/CaHeoNas/disk_1 cifs uid=1000,gid=1000,vers=3,credentials=/home/yourhome/.auth 0 0
#+END_SRC
